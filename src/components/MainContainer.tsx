...
interface ConversationItemAnswer {
  question: string,
  answer: string,
}

interface ConversationAnswers {
  answers: ConversationItemAnswer[]
}
...
export default function MainContainer() {
  ...
  const addAnswer = (newAnswer: string): void => {
    const conversationAnswer: ConversationItemAnswer = { question: question(), answer: newAnswer };
